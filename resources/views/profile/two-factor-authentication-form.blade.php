<x-jet-action-section>
    <x-slot name="content">
        ...
        <h3 class="flex gap-2 mt-4 text-lg font-medium text-indigo-400">
            ...
            @if ($showingQrCode)
                ...
                @if ($showingConfirmation)
                    <div class="mt-4">
                        ...
                        <x-jet-input id="code" type="text" name="code" class="block w-1/2 mt-1" inputmode="numeric" autofocus autocomplete="one-time-code"
