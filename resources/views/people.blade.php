            ...
            <div class="p-1 mx-auto rounded-full bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500 w-fit">
                <div class="flex justify-center gap-2 p-2 bg-black rounded-full ">
                    @if ($user->artist->facebook)
                        <a href="https://{{ $user->artist->facebook }}" target="_blank"
                    ...
                    @if ($user->artist->twitter)
                        <a href="https://{{ $user->artist->twitter }}" target="_blank"
                            class="sm:p-1 p-0.5 rounded-full focus:ring focus:ring-indigo-500">
                            <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24"
                                class="w-6 h-6 transition bg-indigo-500 rounded-full hover:scale-110">
                                <path
                    ...
                    @if ($user->artist->instagram)
                        <a href="https://{{ $user->artist->instagram }}" target="_blank"
                            class="sm:p-1 p-0.5 rounded-full focus:ring focus:ring-indigo-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"
                                class="p-0.5 w-6 h-6 transition hover:scale-110 bg-indigo-500 rounded-full">
                                <path
                    ...
                    @if ($user->artist->dribble)
                        <a href="https://{{ $user->artist->dribble }}" target="_blank"
                            class="sm:p-1 p-0.5 rounded-full focus:ring focus:ring-indigo-500">
                    ...
                    @if ($user->artist->behance)
                        <a href="https://{{ $user->artist->behance }}" target="_blank"
                            class="sm:p-1 p-0.5 rounded-full focus:ring focus:ring-rose-500">
                            <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24"
                                class="w-6 h-6 transition bg-indigo-500 rounded-full hover:scale-110">
                                <path
                    ...
                    @if ($user->artist->pinterest)
                        <a href="https://{{ $user->artist->pinterest }}" target="_blank"
                            class="sm:p-1 p-0.5 rounded-full focus:ring focus:ring-indigo-500">
                            <svg xmlns="http://www.w3.org/2000/svg" width="2500" height="2500"
                                viewBox="0 0 999.9 999.9"
                                class="p-0.5 w-6 h-6 transition hover:scale-110 bg-gray-800 rounded-full">
                                <path
                    ...
                    @if ($user->artist->deviantart)
                        <a href="https://{{ $user->artist->deviantart }}" target="_blank"
                            class="sm:p-1 p-0.5 rounded-full focus:ring focus:ring-indigo-500">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"
                                class="w-6 h-6 transition bg-indigo-500 rounded-full hover:scale-110">
                                <path
                    ...
                    @if ($user->artist->tiktok)
                        <a href="https://{{ $user->artist->tiktok }}" target="_blank"
                            class="sm:p-1 p-0.5 rounded-full focus:ring focus:ring-indigo-500">
