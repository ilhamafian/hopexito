<x-app-layout>
    <div
        class="font-mono w-full p-8 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-amber-200/60 via-violet-900 to-neutral-900">
        <div class="relative h-96">
            <div class="z-0 ">
                <img src="{{ asset('storage/cover-image/' . $artist->cover_image) }}" alt=""
                    class="absolute inset-0 object-cover w-full h-full transition shadow-lg rounded-xl hover:shadow-indigo-500/30" />
            </div>
            ...
            <div class="flex justify-center gap-2 my-4">
                @if ($artist->facebook)
                    <a href="https://{{ $artist->facebook }}" target="_blank"
                        class="p-1 rounded-full focus:ring focus:ring-indigo-500">
                        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 100 100"
                            class="w-8 h-8 transition hover:scale-110">
                            <path
                ...
                @if ($artist->dribble)
                    <a href="https://{{ $artist->dribble }}" target="_blank"
                        class="p-1 rounded-full focus:ring focus:ring-indigo-500">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 transition hover:scale-110">
                            <path
                ...
                @if ($artist->behance)
                    <a href="https://{{ $artist->behance }}" target="_blank"
                        class="p-1 rounded-full focus:ring focus:ring-rose-500">
                        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24"
                            class="w-8 h-8 transition hover:scale-110">
                            <path
                ...
                @if ($artist->deviantart)
                    <a href="https://{{ $artist->deviantart }}" target="_blank"
                        class="p-1 rounded-full focus:ring focus:ring-indigo-500">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"
                            class="transition w-7 h-7 hover:scale-110">
                            <path
