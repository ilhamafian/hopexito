<x-app-layout>
    <x-jet-authentication-card>
        ...
        <div x-data="{ recovery: false }">
            <div class="mb-4 text-sm text-left text-gray-300" x-show="! recovery">
            ...
            <form method="POST" action="{{ route('two-factor.login') }}">
                ...
                <div class="flex items-center justify-end mt-4">
                    <button type="button" class="text-sm text-gray-400 underline cursor-pointer hover:text-indigo-400"
                                    x-show="! recovery"
                                    x-on:click="
                                        recovery = true;
