                ...
                <div class="relative py-2">
                    ...
                    <div class="relative flex flex-col pl-2 group w-fit">
                        ...
                        <div class="absolute bottom-0 flex-col hidden mb-4 group-hover:flex">
                            <span
                                class="relative z-10 p-2 leading-none text-white whitespace-no-wrap bg-black shadow-lg text-xs w-[480px]">Create
                                a descriptive title that effectively describes your artwork, making it more discoverable
                                through relevant searches.</span>
                        </div>
                    </div>
                    ...
                    <div class="relative flex flex-col pl-2 group w-fit">
                        ...
                        <div class="absolute bottom-0 hidden mb-4 group-hover:flex">
                            <span
                                ...
                                are another way for your audience to discover your product. Use a maximum of 5 relevant
                        ...
                        <div class="flex">
                            ...
                            <div class="relative flex flex-col pl-2 group">
                                ...
                                <div class="absolute bottom-0 hidden mb-6 group-hover:flex">
                                    <span
                                        class="relative z-10 p-2 text-xs leading-none text-white whitespace-no-wrap bg-black shadow-lg w-96">Set
                                        a preview color that accurately reflects your design and elevates its overall
                                        visual appeal</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="relative flex flex-col pl-2 group">
                                ...
                                <div class="absolute bottom-0 flex-col hidden mb-6 group-hover:flex">
                                    <span
                                        class="relative z-10 p-2 text-xs leading-none text-white whitespace-no-wrap bg-black shadow-lg w-96">To
                                        ensure that the design looks its best, not all colors may be compatible.
                                        Therefore, you can select the available colors for your product.</span>
                                </div>
                            </div>
                        </div>
