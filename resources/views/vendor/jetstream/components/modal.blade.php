...
>
    ...
    <div x-show="show" class="mb-6 bg-black border-2 border-indigo-500 shadow-rose-500 shadow-md rounded-lg overflow-hidden transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
