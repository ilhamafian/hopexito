<div class="p-12">
    <div class="flex flex-col items-center mb-4">
        ...
        <p class="-mt-4 text-sm">Sign in to access your account and continue shopping with a faster checkout.</p>
    </div>
    <form method="POST" action="{{ route('login') }}" class="">
        ...
        <div class="flex items-center justify-end mt-6">
            @if (Route::has('password.request'))
                <a class="text-sm text-gray-400 underline hover:text-indigo-400" href="{{ route('password.request') }}">
    ...
    <a href="{{ route('register') }}"  >
        <x-jet-button-utility class="w-full mt-5"><span class="p-1 mx-auto">Continue to Sign Up</span></x-jet-button-utility>
    </a>
</div>
