<div class="bg-black/50">
    <div class="mx-auto text-white py-28 px-14 max-w-7xl">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div class="mx-auto">
                <x-jet-application-logo />
                <ul class="flex justify-center gap-6 mt-8 sm:justify-start md:gap-8">
                    <li>
                    ...
                    <li>
                        <a href="https://instagram.com/hopexito" target="_blank"
                            class="text-indigo-400 transition hover:text-indigo-600">
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                <div class="text-center sm:text-left">
                    <p class="text-xl font-medium text-indigo-400">Explore</p>
                ...
                <div class="text-center sm:text-left">
                    <p class="text-xl font-medium text-indigo-400">About</p>
                        <ul class="mt-8 space-y-4 text-sm">
                            <li>
                                <a class="transition hover:text-indigo-400" href="/">
                                    About Us
                    ...
                    <ul class="mt-8 space-y-4 text-sm text-indigo-400">
                        <li>
                            <div class="flex items-center justify-center gap-1.5 sm:justify-start">
                                ...
                                <span>support@hopexito.com</span>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center justify-center gap-1.5 sm:justify-start">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-indigo-400 shrink-0"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                </svg>
                                <span>010-2592210</span>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="pt-6 mt-12 border-t-2 border-indigo-400">
            <div class="text-center sm:flex sm:justify-between sm:text-left">
                ...
                <p class="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">
                    &copy; 2023 HopeXito. All Rights Reserved
                </p>
            </div>
        </div>
    </div>
